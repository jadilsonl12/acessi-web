        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
          ...
          <div className="space-y-6">
            ...
            <div className="mb-6">
              <div style={{ position: "relative", paddingTop: "56.25%" }}>
                <iframe
                  ...
                  title="DigitalFlow Web Development Showcase"
                />
              </div>
            </div>
            ...
            <Button
              ...
              onClick={() => window.open("https://www.digitalflow.dev/", "_blank")}
            >
            ...
            <div className="mb-6">
              <div style={{ position: "relative", paddingTop: "56.25%" }}>
                <iframe
                  ...
                  allowFullScreen={true}
                  className="rounded-lg"
                  title="CodeCraft Studio Portfolio Showcase"
                />
              </div>
            </div>
